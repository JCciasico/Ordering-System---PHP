<?php
    ...
    $query = "select * from food_list where id=(select max(id) from food_list)";
...
<body>
    ...
    <section class="table">
        <div class="container form-container">
            <div class="nav-menu">
                <ul class="nav"> 
                    <li><a href="burgertable.php"><img src="https://img.icons8.com/dusk/64/000000/circled-left-2.png"/></a></li>
            ...
            <form action="insert.php" method="POST" class="form-box">
                ...
                <input type="text" id="image" name="image" placeholder="Ex. images/burger.png" required>
