...
if(isset($_POST["order"])){
    ...
    if(isset($_SESSION["order_cart"]))  
      {  
            $item_array_name = array_column($_SESSION["order_cart"], "item_name");  
            ...
            {  
                    ...
                    echo '<script>window.location="index-chicken.php"</script>';  
            }
      }  
      else  
      {  
        ...
        <div class="container food-container">
            ...
            <div class="box left">
                ...
                <div class="categories">
                    <a href="index.php"class="choice grilled-1">
                        <p>Flame Grilled Burgers</p>
                    </a>
                    <a href="#" class="choice chicken-1">
                ...
                <h2 class="text-center" id="burger-title">Chicken Burgers & More</h2>


                <div class="list-body">
                    <?php

                        $query = "SELECT * FROM table_2 WHERE active = 'Yes'";
                        ...
                        if(mysqli_num_rows($result)>0)
                        {
                            ...
                            {
                        ?>
                        <form action="index-chicken.php?action=add&name=<?php echo $row["name"];?>" class="food-box" method="POST">
                        ...
                        <?php   
                            ...
                            ?>  
                                <tr class="table-text">  
                                    ...
                                    <td><a href="index-chicken.php?action=delete&name=<?php echo $values["item_name"]; ?>" id="remove"><img src="../images/remove.png" alt="remove"></a></td>  
                                </tr>  
                                <?php  
